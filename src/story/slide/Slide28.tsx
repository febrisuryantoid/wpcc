...
const Slide28Content: React.FC<SceneProps> = ({ scene }) => {
  ...
  return (
    ...
    >
      <div className="w-full max-w-7xl mx-auto flex flex-col lg:flex-row gap-6 items-center justify-between h-full max-h-full">
        ...
        <div className="w-full lg:w-[42%] flex flex-col items-center sm:items-start text-center sm:text-left shrink-0">
          ...
          <h2 className="wpcc-h3 font-bold text-white tracking-[-0.02em] leading-[1.15] font-serif drop-shadow-2xl text-center sm:text-left mb-2 whitespace-normal">
          ...
          <motion.div 
            ...
            className="flex items-center justify-center sm:justify-start max-w-lg mx-auto sm:mx-0 w-full wpcc-divide-container mb-3"
          >
          ...
          <p className="text-[12px] sm:text-[13px] md:text-[14px] font-normal text-slate-300 mb-5 leading-relaxed wpcc-slide-desc">
