...
export const SlideCostEffortComparison: React.FC<SceneProps> = (props) => {
  if (!props.isActive) return null;

  return (
    <SlideAnimationProvider scene={props.scene} isActive={props.isActive}>
      <SlideCostEffortComparisonContent {...props} />
    </SlideAnimationProvider>
  );
};

const SlideCostEffortComparisonContent: React.FC<SceneProps> = ({ scene }) => {
  const { 
    headingShowMode, 
    descriptionShowMode, 
    headingDuration, 
