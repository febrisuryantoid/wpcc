...
export const SlideCover: React.FC<CoverPageProps> = ({ onStart, isMusicMuted = false, onToggleMusic, onSpinStart }) => {
  ...
  return (
    ...
    >
      ...
      {/* Centered Cover Content - WPCC Icon at the center of the sphere */}
...
export const CoverPage = SlideCover;
